...
// Interface untuk stock detail per cabang
...
// Interface untuk branch wide stock data lengkap
...
// Interface untuk external API response
export interface BranchWideStockExternalApiResponse {
  message: string;
  data: BranchWideStockData;
}

// Interface untuk tabel branch stock display
