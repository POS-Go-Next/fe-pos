// components/shared/customer-doctor-dialog.tsx - REFACTORED WITH REUSABLE COMPONENTS
"use client";
    ...
    const handleSubmit = async () => {
        ...
        if (viewMode === "customer-only" && customerForm.name) {
            ...
            if (createdCustomer) {
                ...
                console.log(
                    "🔄 Switched back to 'both' mode with new customer data"
                );
            } else {
            ...
            if (createdDoctor) {
                ...
                console.log(
                    "🔄 Switched back to 'both' mode with new doctor data"
                );
            } else {
            ...
            if (doctorForm.fullname && !selectedDoctorId) {
                if (validateDoctorForm()) {
                    console.log(
                        "👨‍⚕️ Creating new doctor via API (both mode)..."
                    );
                    const createdDoctor = await createDoctorViaAPI();
                    if (createdDoctor) {
                        console.log(
                        ...
                        console.log(
                            "❌ Doctor creation failed, continuing without doctor"
                        );
