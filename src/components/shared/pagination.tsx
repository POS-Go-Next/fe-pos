...
export default function Pagination({
  ...
  if (currentPage < 1 || currentPage > totalPages) {
    console.warn('Invalid currentPage:', currentPage, 'totalPages:', totalPages);
    return null;
  }
        ...
        if (totalPages > 5) {
          pages.push(
            <Button
              ...
              title={`Go to page ${Math.min(totalPages, currentPage + 5)}`}
            >
              ...
            </Button>
          );
  ...
  return (
    <div className={`flex justify-center items-center gap-1 px-4 py-2 ${className}`}>
      <Button
        variant="outline"
        size={config.buttonSize}
