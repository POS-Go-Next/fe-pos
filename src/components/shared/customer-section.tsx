// components/shared/customer-section.tsx
"use client";
        ...
        <div className="grid grid-cols-2 gap-4">
            ...
            {viewMode === "customer-only" ? (
              <Input
                ...
                className={`bg-[#F5F5F5] border-none h-[52px] focus:ring-2 focus:ring-blue-500 transition-all duration-200 ${
                  validationErrors.customerName ? "ring-2 ring-red-500" : ""
                }`}
              />
            ) : (
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => onCustomerChange("gender", value)}
              disabled={isSubmitLoading}
            >
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => onCustomerChange("age", e.target.value)}
              disabled={isSubmitLoading}
              className={`bg-[#F5F5F5] border-none h-[52px] focus:ring-2 focus:ring-blue-500 transition-all duration-200 ${
                validationErrors.customerAge ? "ring-2 ring-red-500" : ""
              }`}
            />
          ...
          <div>
            ...
            <Input
              ...
              disabled={isSubmitLoading}
              className={`bg-[#F5F5F5] border-none h-[52px] focus:ring-2 focus:ring-blue-500 transition-all duration-200 ${
                validationErrors.customerPhone ? "ring-2 ring-red-500" : ""
              }`}
            />
          ...
          <div>
            ...
            <Input
              ...
              disabled={isSubmitLoading}
              className={`bg-[#F5F5F5] border-none h-[52px] focus:ring-2 focus:ring-blue-500 transition-all duration-200 ${
                validationErrors.customerAddress ? "ring-2 ring-red-500" : ""
              }`}
            />
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => onCustomerChange("status", value)}
              disabled={isSubmitLoading}
            >
              <SelectTrigger className="bg-[#F5F5F5] border-none h-[52px] focus:ring-2 focus:ring-blue-500 transition-all duration-200">
