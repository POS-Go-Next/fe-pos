// components/shared/transaction-type-dialog.tsx
"use client";
      ...
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
        ...
        <div className="p-6 space-y-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setTransactionType("Full Prescription")}
                className={`flex-1 py-3 px-4 rounded-lg border-2 font-medium transition-all ${
              ...
              <button
                onClick={() => setTransactionType("Partial Prescription")}
                className={`flex-1 py-3 px-4 rounded-lg border-2 font-medium transition-all ${
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => setAvailability("Patient Credit")}
                className={`flex-1 py-3 px-4 rounded-lg border-2 font-medium transition-all ${
                  availability === "Patient Credit"
                    ? "bg-blue-600 text-white border-blue-600"
                    : "bg-white text-gray-700 border-gray-200 hover:border-gray-300"
