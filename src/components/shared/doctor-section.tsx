// components/shared/doctor-section.tsx
"use client";
...
interface DoctorSectionProps {
  ...
  onDoctorChange: (field: keyof DoctorFormData, value: string | number) => void;
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-200">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-medium text-gray-900">Doctor Info</h3>
            <span className="text-gray-500 text-sm font-medium">
              {viewMode === "doctor-only" ? "*Required" : "Optional"}
            </span>
          </div>
          {viewMode === "both" && (
            <Button
        ...
        <div className="grid grid-cols-2 gap-4">
            ...
            {viewMode === "doctor-only" ? (
              <Input
                ...
                className={`bg-[#F5F5F5] border-none h-[52px] focus:ring-2 focus:ring-blue-500 transition-all duration-200 ${
                  validationErrors.doctorFullname ? "ring-2 ring-red-500" : ""
                }`}
              />
            ) : (
              <div className="relative" ref={doctorContainerRef}>
                ...
                <DropdownPortal
                  ...
                  onClose={() => setIsDoctorDropdownOpen(false)}
                >
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => onDoctorChange("sip", e.target.value)}
              disabled={isSubmitLoading}
              className={`bg-[#F5F5F5] border-none h-[52px] focus:ring-2 focus:ring-blue-500 transition-all duration-200 ${
                validationErrors.doctorSip ? "ring-2 ring-red-500" : ""
              }`}
            />
          ...
          <div>
            ...
            <Input
              ...
              disabled={isSubmitLoading}
              className={`bg-[#F5F5F5] border-none h-[52px] focus:ring-2 focus:ring-blue-500 transition-all duration-200 ${
                validationErrors.doctorPhone ? "ring-2 ring-red-500" : ""
              }`}
            />
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => onDoctorChange("address", e.target.value)}
              disabled={isSubmitLoading}
              className={`bg-[#F5F5F5] border-none h-[52px] focus:ring-2 focus:ring-blue-500 transition-all duration-200 ${
                validationErrors.doctorAddress ? "ring-2 ring-red-500" : ""
              }`}
            />
