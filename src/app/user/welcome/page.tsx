        ...
        <div className="bg-white">
          <div className="flex p-12 gap-8">
            ...
            <div className="w-[40%] flex flex-col justify-center items-center">
              <div className="mb-6">
                <div className="w-24 h-24 bg-yellow-400 rounded-full mx-auto"></div>
              </div>
              <div className="text-center mb-8">
                ...
                <div className="text-gray-600 text-sm space-y-1">
                  <p>Jl. Biak No.39, RW.1, Cideng,</p>
                  <p>Kecamatan Gambir, Kota Jakarta Pusat,</p>
                  <p>Daerah Khusus Ibukota Jakarta 10150</p>
                </div>
              </div>
              <button className="bg-teal-500 text-white px-8 py-3 rounded-lg text-lg font-medium mb-8">
            ...
            <div className="flex space-x-4 overflow-hidden">
              {Array.from({ length: 7 }).map((_, index) => (
                <div
                  ...
                  style={{ width: "calc((100% - 6 * 1rem) / 6.5)" }}
                >
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="bg-gray-200 px-2 py-1 rounded text-xs w-16 h-6"></div>
                    </div>
                  </div>
                </div>
              ))}
