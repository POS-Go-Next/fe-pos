...
const FingerprintSetupDialog: FC<FingerprintSetupDialogProps> = ({
  ...
  // ✅ FIXED: Check localStorage instead of cookies
  ...
  // ✅ FIXED: Simple auth check when dialog opens
  useEffect(() => {
    if (isOpen) {
      ...
      if (hasValidToken) {
        console.log("✅ FingerprintDialog - Valid token found in localStorage");
        // Directly set as authenticated, no need for additional API calls
        handleLoginSuccess({
          id: 1,
          fullname: "User",
          username: "user",
        ...
        console.log("❌ FingerprintDialog - No valid token, need login");
        checkAuthentication();
      }
    }
  ...
  // ✅ FIXED: Show login dialog only when needed and no localStorage auth
          ...
          <div className="p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                Employee: <strong>{employeeState.selectedEmployeeName}</strong>
              </p>
            </div>
          ...
          <div className="p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                ...
                <strong>{employeeState.selectedEmployeeName}</strong>
              </p>
            </div>
