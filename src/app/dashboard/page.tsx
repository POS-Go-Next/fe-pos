...
export default function DashboardPage() {
    ...
    const [isFingerprintDialogOpen, setIsFingerprintDialogOpen] =
        useState(false);
            ...
            >
                <div className="flex items-center justify-center min-h-[calc(100vh-4rem)]">
                    <div className="w-[960px] rounded-[56px] border-2 border-white backdrop-blur-[80px] bg-white/25 p-12 shadow-2xl">
                        <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 mb-4 shadow-lg">
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                                <div>
                                    <h1 className="font-semibold text-black mb-2">
                                        Simplify Transactions with an Integrated
                                        POS System
                                    </h1>
                                    <p className="text-[#8C8C8C] flex items-center gap-2 text-sm">
                                        Fast, Accurate, and Reliable Checkout
                                        Experience
                                        <Image
                                            src="/icons/smile.svg"
                                            width={20}
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-4">
                            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg h-full flex flex-col">
                                ...
                                <p className="text-sm text-[#8C8C8C] mb-6 flex-grow">
                                    Add items, apply promo, and complete
                                    payments seamlessly.
                                </p>
                                <button
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-[#8C8C8C]">
                                                    Manage shifts, doctor fees,
                                                    outlet settings, and receipt
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-white">
                                                    Register your fingerprint to
                                                    unlock, approval and access
                                                    the POS system.
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg h-full flex flex-col">
                                ...
                                <p className="text-sm text-[#8C8C8C] mb-6 flex-grow">
                                    Set terminal details like MAC address,
                                    queue, and POS type.
                                </p>
                                <button
                            ...
                            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg h-full flex flex-col">
                                ...
                                <p className="text-sm text-[#8C8C8C] mb-6 flex-grow">
                                    End cashier session and generate a summary
                                    report.
                                </p>
                                <button
                                    className="w-full bg-blue-600 text-white font-medium h-11 px-4 rounded-xl transition-colors hover:bg-blue-700"
                            ...
                            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg h-full flex flex-col">
                                ...
                                <p className="text-sm text-[#8C8C8C] mb-6 flex-grow">
                                    Retry closing the cashier session for
