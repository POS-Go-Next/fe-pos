...
const PrescriptionDiscountDialog: React.FC<PrescriptionDiscountDialogProps> = ({
  ...
  // Get position_id and set discountMax
  useEffect(() => {
    try {
  ...
  useEffect(() => {
    if (isOpen && selectedProduct) {
      setSku(
        selectedProduct.stockData?.kode_brg || selectedProduct.kode_brg || ""
      );
      setProductName(selectedProduct.nama_brg || selectedProduct.name || "");
    }
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    if (!isNaN(value) && value >= 0 && value <= discountMax) {
                      setDiscount(value);
                    }
                  }}
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="text-red-700">
                <span className="font-medium">
                  Discount &lt;= {discountMax}% AA ; Discount &gt; {discountMax}
                  % OLM
                </span>
              </div>
            </div>
