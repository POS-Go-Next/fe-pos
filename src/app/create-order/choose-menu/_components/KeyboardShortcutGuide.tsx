...
const KeyboardShortcutGuide: React.FC<KeyboardShortcutGuideProps> = ({
    ...
    const rightColumnShortcuts = [
        { key: "Alt + T", description: "Retur Semua Barang" },
        {
            key: "Alt + K",
            description:
                "Menandakan Transaksi tidak biasa (Khusus). Contoh : Diborong, Tender, dll. Sehingga tidak masuk Perhitungan Permintaan Barang.",
        },
        ...
        { key: ", (Koma)", description: "Delete SC (Hanya Resep)" },
        {
            key: "~ (Tilde)",
            description:
                "Calculator (Tekan enter untuk pembulatan keatas, Tekan ~ lagi untuk masuk Qty)",
        },
