...
import { Product } from "./_components/ChooseMenuProductTable";
...
export default function ChooseMenuPage() {
  ...
  // Handle product name click (open dialog)
  ...
  const handleProductSelect = (selectedProduct: any, productId: number) => {
    const price = parseFloat(selectedProduct.hjEcer.replace(/[^0-9]/g, '')) || 0;
